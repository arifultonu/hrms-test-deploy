...
import { IrecruitmentService } from '../../i-recruitment/service/irecruitment.service';
import { VisitorlogService } from '../service/visitorlog.service';


declare const $: any;
@Component({
  selector: 'app-vislist',
  templateUrl: './vislist.component.html',
  styleUrls: ['./vislist.component.css'],
  providers: [DatePipe]
})
export class VislistComponent implements OnInit {
  ...
  private getListData() {
    ...
    let apiURL = this.baseUrl + "/api/visitors/getList";
