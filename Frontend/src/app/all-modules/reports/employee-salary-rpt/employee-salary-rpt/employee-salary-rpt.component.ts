...
@Component({
  selector: 'app-employee-salary-rpt',
  templateUrl: './employee-salary-rpt.component.html',
  styleUrls: ['./employee-salary-rpt.component.css']
})
export class EmployeeSalaryRptComponent implements OnInit {
...
configPgn: any;
  ...
  loadReport(){
    ...
    let reportParams = {};
    reportParams['rptFileName'] = "employe_salary_info_Final_Version";
    reportParams['outputFileName'] = "employe_salary_info_Final_VersionReport";

    reportParams['EMPLOYEE_ID']=this.myForm.get('empCode').value;

  

    this.reportsService.EmpSalaryRpt(reportParams).subscribe((response:any)=>{
