...
@Component({
  selector: 'app-employee-monthly-rpt',
  templateUrl: './employee-monthly-rpt.component.html',
  styleUrls: ['./employee-monthly-rpt.component.css']
})
export class EmployeeMonthlyRptComponent implements OnInit {
...
configPgn: any;
  ...
  loadReport(){
    ...
    let reportParams = {};
    reportParams['rptFileName'] = "Monthly_Attendence_Report_V3_Final";
    reportParams['outputFileName'] = "Monthly_Attendence_Report_V3_FinalReport";
    ...
    this.reportsService.EmpMonthlyattnRpt(reportParams).subscribe((response:any)=>{
