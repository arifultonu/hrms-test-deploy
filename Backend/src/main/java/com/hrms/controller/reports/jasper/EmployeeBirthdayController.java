...
import com.hrms.service.reports.jasper.EmployeeBirthdayService;
...
public class EmployeeBirthdayController {
    ...
    @Autowired
    EmployeeBirthdayService employeeBirthdayService;
    ...
    public HttpEntity<byte[]> getReport(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            JasperPrint jasperPrint = employeeBirthdayService.generateReport(request);
