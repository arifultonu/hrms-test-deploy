...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="HR_CR_EMP_PRIMARY_ASSGNMNT")
public class HrCrEmpPrimaryAssgnmnt extends BaseEntity {
...
//    @JoinColumn(name = "HR_CR_EMP_ID")
    ...
    @OneToOne(fetch = FetchType.EAGER)
    @JoinColumn(name = "HR_EMP_DESIGNATIONS_ID")
    ...
    public HrCrEmpPrimaryAssgnmnt(String active,HrCrEmp hrCrEmpId) {
        this.empPaySts=active;
        this.hrCrEmpHrmId=hrCrEmpId;
    }
